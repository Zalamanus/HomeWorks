...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                Double open1 = stock1.get("open") != null ? (double) stock1.get("open") : null;
                Double open2 = stock2.get("open") != null ? (double) stock2.get("open") : null;
                Double last1 = stock1.get("last") != null ? (double) stock1.get("last") : null;
                Double last2 = stock2.get("last") != null ? (double) stock2.get("last") : null;
                Double change1 = stock1.get("change") != null ? (double) stock1.get("change") : null;
                Double change2 = stock2.get("change") != null ? (double) stock2.get("change") : null;
                Double profit1 = (last1 != null && open1 != null) ? last1 - open1 : null;
                Double profit2 = (last2 != null && open2 != null) ? last2 - open2 : null;
                int res;
                res = name1.compareTo(name2);
                if (res == 0) res = date2.compareTo(date1);
                if (res == 0)
                    if (change2 != null && change1 != null) {
                        res = change2.compareTo(change1);
                    } else if (profit2 != null && profit1 != null) {
                        res = profit2.compareTo(profit1);
                    } else if (change2 != null && profit1 != null) {
                        res = change2.compareTo(profit1);
                    } else if (profit2 != null && change1 != null) {
                        res = profit2.compareTo(change1);
                    }
                return res;
            }
        });
    ...
    public static List<Stock> getStocks() {
        ...
        stocks.add(new Stock("Fake Nokia Corporation (ADR)", "NOK", .4, new Date()));
        stocks.add(new Stock("Fake Nokia Corporation (ADR)", "NOK", .1, new Date()));
