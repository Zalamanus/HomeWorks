...
public class Solution
{
    ...
    public static void checkSeason(int mount){
        if (mount < 3) System.out.println("зима");
        else if (mount < 6) System.out.println("весна");
        else if (mount < 9) System.out.println("лето");
        else if (mount < 12) System.out.println("осень");
