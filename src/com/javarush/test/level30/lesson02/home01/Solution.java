...
public class Solution {
    ...
    public static Number convertNumberToOtherNumerationSystem(Number number, NumerationSystem expectedNumerationSystem) {
        if (number.getDigit().matches(".*[\\\\.\\\\,-]+.*")) throw new NumberFormatException();
        ...
        radix = expectedNumerationSystem.getNumerationSystemIntValue();
        return new Number(expectedNumerationSystem,bigInteger.toString(radix));
    }
}
